...
export function OwnerMenusPage() {
  ...
  useEffect(() => {
    if (!selectedBranchSlug && branchesQuery.data?.length)
      setSelectedBranchSlug(branchesQuery.data[0].slug);
        ...
        <>
            ...
            <section className="mb-14">
              <div className="mb-5 flex items-start justify-between gap-4">
                <MenuHeader
                  ...
                  onDelete={() => setMenuPendingDeletion(selectedMenu)}
                ...
                <Button
                  ...
                  onClick={() => setShowAddItem((visible) => !visible)}
                >
                  <Plus className="h-4 w-4" />
                  Add Item
                </Button>
          ...
          <BranchMenuSection
            ...
            onOverrideItem={(menuItemId, payload) =>
              overrideMutation.mutate({ menuItemId, payload })
            }
          />
        </>
      )}
...
function NoMenusState() {
  return (
    <Card className="rounded-2xl border-[#EAE4DC] bg-white p-10 text-center">
      ...
      <h3 className="mt-4 font-serif text-xl text-[#292524]">No menus yet</h3>
