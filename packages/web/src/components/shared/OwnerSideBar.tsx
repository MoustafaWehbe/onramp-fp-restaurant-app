        ...
        <aside className="fixed inset-y-0 left-0 z-40 flex w-[400px] flex-col border-r border-[#EAE4DC] bg-white">
            ...
            <div className="px-6 pb-8 pt-7">
                <div className="flex items-center gap-3">
                    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-orange-500 font-serif text-xl font-bold text-white shadow-sm">
                        P
                    </div>
            ...
            <div className="border-t border-[#EEE9E2] px-4 pb-5 pt-4">
                <div className="mb-3 rounded-2xl border border-[#EEE9E2] bg-[#FCFAF7] p-3">
                    <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-orange-500 font-serif text-sm font-semibold text-white shadow-sm">
                            {userName
        ...
        <div className="mb-7">
            ...
            <div className="space-y-1">
                {items.map((item) => {
                    ...
                    // Disabled items: no route, no NavLink, never turn orange
                    if (item.disabled || !item.path) {
                        return (
                            <div
                                key={item.label}
                                className="group flex w-full cursor-not-allowed items-center gap-3 rounded-xl px-3.5 py-3 text-sm text-[#C4BFB8]"
                            >
                                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg">
                                    <Icon
                                        className="h-[17px] w-[17px] text-[#D6D1C9]"
                                        strokeWidth={1.7}
                                    />
                                </div>
